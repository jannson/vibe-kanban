...
export type Project = { id: string, name: string, workspace_root: string | null, dev_script: string | null, dev_script_working_dir: string | null, default_agent_working_dir: string | null, remote_project_id: string | null, created_at: Date, updated_at: Date, };

export type CreateProject = { name: string, workspace_root: string | null, repositories: Array<CreateProjectRepo>, };
...
export type Workspace = { id: string, task_id: string, container_ref: string | null, use_original_repos: boolean | null, branch: string, agent_working_dir: string | null, setup_completed_at: string | null, created_at: string, updated_at: string, };
 ...
 */
agent_run_index: bigint | null, started_at: string, completed_at: string | null, created_at: string, updated_at: string, };
...
export type CommitTaskAttemptRequest = { repo_id: string, message: string | null, };
...
export type CreateAndStartTaskRequest = { task: CreateTask, executor_profile_id: ExecutorProfileId, repos: Array<WorkspaceRepoInput>, use_original_repos: boolean | null, };
...
export type CreateTaskAttemptBody = { task_id: string, executor_profile_id: ExecutorProfileId, repos: Array<WorkspaceRepoInput>, use_original_repos: boolean | null, };
...
export type ExecutionLogCleanupResponse = { storage_before: ExecutionLogStorageStats, storage_after: ExecutionLogStorageStats, deleted_rows: bigint, deleted_bytes: bigint, dropped_rows: bigint, dropped_bytes: bigint, retained_rows: bigint, retained_bytes: bigint, intermediate_rows: bigint, intermediate_bytes: bigint, };
