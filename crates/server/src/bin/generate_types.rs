...
// If you are an AI, and you absolutely have to edit this file, please confirm with the user first.";
    ...
    let decls: Vec<String> = vec![
        ...
        server::routes::config::TestRemoteNotifierTargetRequest::decl(),
        server::routes::config::TestRemoteNotifierTargetResponse::decl(),
        ...
        server::routes::task_attempts::ResumeTaskAttemptResponse::decl(),
        ...
        server::routes::config::ExecutionLogStorageStats::decl(),
        server::routes::config::ExecutionLogCleanupResponse::decl(),
        server::routes::config::DatabaseVacuumResponse::decl(),
        ...
        services::services::config::QuickReplyRule::decl(),
        db::models::execution_process_logs::ExecutionLogCleanupStats::decl(),
        services::services::config::NotificationConfig::decl(),
        services::services::config::RemoteNotificationsConfig::decl(),
        services::services::config::RemoteNotifierTarget::decl(),
        services::services::config::RemoteNotifierProjectFilter::decl(),
        services::services::config::ReviewReadyNotificationStrategy::decl(),
